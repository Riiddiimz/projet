...
function sendOnlineUserList(){
    ...
    for(
        ...
        /*
         * Un utilisateur est considéré comme réellement
         * connecté uniquement si sa WebSocket est ouverte.
         */
    ...
    ws => {
            ...
            raw => {
                ...
                if(
                    ...
                    for(
                        ...
                        /*
                         * On bloque uniquement un nom actuellement
                         * utilisé par un utilisateur encore connecté.
                         */
                ...
                if(
                    ...
                    if(
                        typeof message.avatarUrl ===
                        "string" &&
                        message.avatarUrl.length <=
                            MAX_AVATAR_LENGTH
                    ){
        ...
        ws.on(
            ...
            () => {
                ...
                /*
                 * On conserve la session et l'utilisateur pour
                 * permettre un refresh de page.
                 */
